...
const DIV = {
  "division-group": {
    ...
    caps: caps([["First-ever token sale", "Launched the first token sale in blockchain history, Mastercoin, 2013. Powering 100+ prominent tokens through the ICO era and beyond."], ["Digital Asset media leadership", "Regular placements in every leading digital asset publication, CoinDesk, Cointelegraph, Decrypt, plus top industry podcasts and YouTube channels."], ["Tier-1 mainstream coverage", "Client stories placed in AP, BBC, Bloomberg, Business Insider, CNBC, Forbes, Fox, The New York Times, Reuters, TechCrunch, USA Today, VentureBeat, Wall Street Journal, and WIRED."], ["Global office network", "San Juan HQ with additional offices in New York, Los Angeles, San Francisco, Las Vegas, and Toronto, the most extensive footprint in digital asset PR."]]),
  ...
  "division-events": {
    ...
    caps: caps([["Tokenize conference", "A premier blockchain conference exploring the future of tokenization. Global edition."], ["BitAngels network", "World's first digital asset angel investor network. Active since 2013."], ["Tiger Mansion", "Invite-only executive gathering for top-tier digital asset investors and founders."], ["CoinAgenda legacy", "Predecessor conference series connecting mainstream investors with blockchain deals."]]),
    stats: stats([["2013", "BitAngels Founded"], ["Global", "Tokenize Reach"], ["Invite Only", "Tiger Mansion"], ["10+", "Years of Events"]]),
  },
  "division-capital": {
    hero: { eyebrow: "/ 03, Family Office", title: "Michael Terpin's family office.", intro: "Deploying strategic capital into blockchain protocols, DeFi infrastructure, and digital asset projects. A Puerto Rico-based digital asset family office with deep conviction and a long-term investment horizon." },
    ...
    stats: stats([["10+", "Years in Digital Asset"], ["Multi", "Strategy Approach"], ["Direct", "Portfolio Access"], ["Global", "Network Reach"]]),
  },
  "division-strategies": {
    hero: { eyebrow: "/ 04, Advisory & Consulting", title: "Expert advisory for blockchain projects.", intro: "Decades of combined experience in token launch strategy, digital asset go-to-market planning, tokenomics design, and investor relations, helping blockchain ventures succeed from seed to scale." },
...
const DEFAULTS = {
  about: {
    hero: { eyebrow: "About Transform Ventures", title: "Three decades of building at the edges of media and money.", intro: "Transform Ventures is the venture platform of Michael Terpin, founder of Globe Newswire, BitAngels, and Tokenize, operating across five specialized divisions from San Juan, Puerto Rico." },
    story: { eyebrow: "Our Story", heading: "The communications powerhouse behind digital asset." },
    timeline: [
    ...
    team: [
      { name: "Michael Terpin", role: "Founder & CEO", bio: "Michael Terpin is the founder and CEO of Transform Ventures, whose divisions include Transform Group PR, a global public relations firm that has served more than 300 clients in the blockchain field and helped launch more than 150 token sales, including Aeternity, Augur, Bancor, Dent, Ethereum, Factom, Golem, Gnosis, Lisk, MaidSafe, Neo, Qtum, SALT Lending, Tether, VideoCoin, and WAX Token; Tokenize!, an event series for digital asset investors; and Transform Strategies, the company's advisory division. Known as the \"Godfather of Crypto\" (CNBC, 2018), he co-founded BitAngels in 2013 and is CEO and CIO of Supercycle Genesis Partners, a bitcoin-only hedge fund.", photoImg: "assets/michael-terpin.jpg", linkedin: "https://www.linkedin.com/in/michaelterpin/", x: "https://twitter.com/michaelterpin" },
      { name: "Joyce Chow", role: "Director of Events", bio: "Joyce Chow is the Director of Events at Transform Group. She previously founded the iHollywood Film Fest and has worked with major media outlets including CNN and Yahoo!, bringing more than a decade of experience in event production, media, and content development to her role. A graduate of Y Combinator, she has built a career spanning entertainment, blockchain, and emerging technology. At Transform Group, Joyce leads event strategy and production for the agency's blockchain and digital asset clients, drawing on her hands-on experience directing Tokenize! conferences and running global operations for BitAngels, a worldwide ecosystem of founders and funders with a presence in over 35 cities. She is also a Director at Transform Ventures and an active angel investor in blockchain, Web3, AI, and fintech. Joyce is based in San Juan, Puerto Rico, and Los Angeles.", photoImg: "assets/joyce-chow.jpg", linkedin: "#", x: "#" },
      { name: "David Lathrop", role: "Director of Research · Chief of Staff", bio: "David Lathrop has worked as chief of staff with Transform Ventures founder Michael Terpin since 2019, taking on the director of research role in 2021. He works closely with Transform Ventures advisory clients on strategy and research. He holds a Series 3 License from the National Futures Association (NFA) and is an active digital asset options trader. He also holds a research role at Supercycle Genesis Partners, the bitcoin-only hedge fund started by Terpin.", photoImg: "", linkedin: "#", x: "#" },
      { name: "Stephen L. Kanaval", role: "Writer & Analyst", bio: "With over 12 years of experience as a financial markets and digital asset writer, Steve brings specialized expertise in translating complex economic concepts into accessible insights. His technical background as a SQL developer complements his writing, allowing him to analyze data-driven trends with precision. As a certified project manager, he has successfully led software development projects for Fortune 100 clients, coordinating cross-functional teams to deliver solutions that meet enterprise requirements.", photoImg: "", linkedin: "#", x: "#" },
      { name: "Bee Davies", role: "Event Coordinator", bio: "Bee Davies has worked as a host and production coordinator on events for Transform Ventures since 2023. She lives in Los Angeles, where she is also active as an actress and filmmaker.", photoImg: "", linkedin: "#", x: "#" },
    ],
  },
  divisions: {
    hero: { eyebrow: "Our Ecosystem", title: "Five divisions. One vision.", intro: "Transform Ventures operates across five specialized divisions, from pioneering digital asset PR and blockchain events to venture capital, strategic advisory, and a bitcoin-only hedge fund." },
    blocks: [
      { key: "group", num: "01", badge: "Parent Organization", name: "Transform Group", color: "var(--purple)", desc: "The original blockchain PR firm, launched the first-ever token sale (Mastercoin, 2013) and powered 100+ prominent ICO-era launches including Ethereum, EOS, Augur, and Tether.", cap1t: "First-ever token sale", cap1d: "Launched the first token sale in blockchain history, Mastercoin, 2013. Powered 100+ prominent tokens through the ICO era including Ethereum, EOS, Augur, Bancor, Golem, and WAX.", cap2t: "Digital Asset media leadership", cap2d: "Regular placements in every leading digital asset publication, CoinDesk, Cointelegraph, Decrypt, plus top industry podcasts and YouTube channels.", cap3t: "Tier-1 mainstream coverage", cap3d: "Client stories placed in AP, BBC, Bloomberg, CNBC, Forbes, The New York Times, Reuters, TechCrunch, Wall Street Journal, and WIRED.", cap4t: "Global office network", cap4d: "San Juan HQ with offices in New York, Los Angeles, San Francisco, Las Vegas, and Toronto, the most extensive footprint in digital asset PR." },
      { key: "events", num: "02", badge: "Events & Conferences", name: "Transform Events", color: "var(--teal)", desc: "Premier blockchain events connecting founders and investors worldwide through curated gatherings.", cap1t: "Tokenize conference", cap1d: "A premier blockchain conference exploring the future of tokenization. Global edition.", cap2t: "BitAngels network", cap2d: "World's first digital asset angel investor network. Active since 2013.", cap3t: "Tiger Mansion", cap3d: "Invite-only executive gathering for top-tier digital asset investors and founders.", cap4t: "CoinAgenda legacy", cap4d: "Predecessor conference series connecting mainstream investors with blockchain deals." },
  ...
  leadership: {
    hero: { eyebrow: "Leadership", title: "Meet the founder.", intro: "One of the most recognized figures in blockchain and digital asset, early bitcoin investor, author, and the entrepreneur CNBC called the 'Godfather of Crypto.'" },
    leader: {
      role: "Founder & CEO · CIO, Bitcoin Supercycle Fund", name: "Michael Terpin", photoImg: "assets/michael-terpin.jpg",
      para1: "Michael Terpin is the founder and CEO of Transform Ventures, whose divisions include Transform Group PR, a global public relations firm that has served more than 300 clients in the blockchain field and helped launch more than 150 token sales, including Aeternity, Augur, Bancor, Dent, Ethereum, Factom, Golem, Gnosis, Lisk, MaidSafe, Neo, Qtum, SALT Lending, Tether, VideoCoin, and WAX Token; Tokenize!, an event series for digital asset investors; and Transform Strategies, the company's advisory division. Transform Ventures, LLC, is headquartered in San Juan, Puerto Rico, with offices in Las Vegas, Los Angeles, Miami, Paris, and Dublin. Terpin also co-founded BitAngels, the world's first angel network for digital currency startups, in May 2013.",
      para2: "Previously, Terpin founded Globe Newswire (originally Internet Wire), one of the world's largest company newswires, which was acquired in 2006, later sold to NASDAQ for $200 million, then to Apollo Global Management for $335 million, and to Equiniti for $535 million in 2025. Equiniti was sold in May 2026 to digital asset exchange Bullish (NYSE: BLSH). He also co-founded Direct IPO, one of the earliest equity crowdfunding companies. He founded his first PR firm, The Terpin Group, which represented many of the early Internet leaders, including America Online, Earthlink, Match.com, and the Motley Fool. The Terpin Group was sold in 2000 to Financial Dynamics, now part of FTI Consulting (NYSE: FCN). Terpin holds an MFA from SUNY at Buffalo and a dual BA in journalism and English from Syracuse University, where he serves on the board of advisors at the Newhouse School of Public Communications. He is also the CEO and Chief Investment Officer of Supercycle Genesis Partners, LP, a Bitcoin-only hedge fund.",
      tags: ["Godfather of Crypto", "Transform Ventures", "Transform Group", "BitAngels Co-Founder", "Tokenize Creator", "Globe Newswire Founder", "Author", "Puerto Rico"],
    },
  ...
  events: {
    hero: { eyebrow: "Transform Events", title: "Where the industry connects.", intro: "Flagship blockchain conferences and digital asset networking events bringing together industry leaders, angel investors, and founders for deal-making and knowledge sharing." },
    ...
    brands: [
      ...
      { name: "Tiger Mansion", tag: "Invite Only", desc: "An exclusive, invite-only gathering for top-tier digital asset investors and founders. Intimate, curated networking.", img: "assets/tigermansion-event.jpg", url: "https://www.tigermansionlv.com/" },
    ],
  },
  media: {
    hero: { eyebrow: "News & Media", title: "In the press.", intro: "Interviews, appearances, and press coverage featuring Michael Terpin and Transform Ventures across leading digital asset and financial media." },
    items: [
  ...
  blog: {
    hero: { eyebrow: "Blog & Insights", title: "Analysis from the Godfather of Crypto.", intro: "Thought leadership and market commentary on bitcoin cycles, digital asset investing, and blockchain technology, from Michael Terpin and the Transform Ventures team." },
    posts: [
      ...
      { id: "bitcoin-only-fund", tag: "Industry", date: "January 2026", title: "The Case for a Bitcoin-Only Hedge Fund", lede: "Most digital asset hedge funds diversify across dozens of altcoins, diluting returns and adding complexity. Managing a portfolio of 50 or 100 different tokens requires deep expertise across multiple ecosystems, constant rebalancing, and exposure to projects that may not survive the next bear market. The result is often mediocre performance that fails to justify the fees charged.", body: ["The Supercycle Fund takes a different approach, 100% bitcoin with tactical positioning across the cycle. By focusing exclusively on bitcoin, the fund eliminates the noise of altcoin selection and concentrates on what matters most: timing the macro cycle correctly and executing with precision.", "Bitcoin's dominance as the macro asset, combined with its predictable halving schedule, makes it the ideal vehicle for a cycle-driven strategy. No other digital asset has the same depth of liquidity, institutional adoption, regulatory clarity, and network security. Bitcoin is the only digital asset asset that has been classified as a commodity by major regulators, making it the most accessible for institutional capital.", "Unlike altcoins which can go to zero, bitcoin has survived every cycle and emerged stronger. Through multiple 80%+ drawdowns, exchange hacks, regulatory crackdowns, and media death spirals, bitcoin's network has continued to grow. Each cycle brings higher lows and higher highs, reinforcing its position as the foundational layer of the digital asset ecosystem.", "For institutional investors seeking digital asset exposure with managed risk, a bitcoin-only approach offers the best risk-adjusted returns. The combination of cycle-based positioning, algorithmic execution, and singular asset focus creates a strategy that is both simple to understand and powerful in execution. The Supercycle Fund is built on the conviction that doing one thing exceptionally well beats doing many things adequately."] },
    ],
  },
  contact: {
